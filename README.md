...
- 🌐 Member of the [Web Hypertext Application Technology Working Group (WHATWG)](https://whatwg.org), responsible for reviewing & contributing to the HTML Standard, [Custom Element Web Components](https://github.com/web-platform-tests/wpt/blob/master/custom-elements/META.yml#L3),[WebRTC API](https://github.com/web-platform-tests/wpt/blob/master/webrtc/META.yml#L3), & Web Audio API.
